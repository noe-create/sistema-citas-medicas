...
import { Stethoscope, User as UserIcon, Moon } from 'lucide-react';
...
const DOCTOR_SCHEDULE = {
  morning: ['carolina.g', 'angela.d', 'dra.salud'], // Usernames of morning shift doctors
    ...
    <Card>
      ...
      <CardContent className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {activeShiftKey ? (
            ...
            <div className="col-span-full flex flex-col items-center justify-center text-center text-muted-foreground h-24">
                <Moon className="h-8 w-8 mb-2" />
                <p className="font-semibold">Fuera de horario de consulta.</p>
                <p className="text-sm">El próximo turno inicia a las 7:00 AM.</p>
            </div>
        )}
      </CardContent>
    </Card>
