  ...
  return (
    ...
    >
        <g clipPath="url(#clip0_2_2)">
            ...
            <path d="M28.014 38.507C24.871 38.507 22.288 41.09 22.288 44.233V53.46C22.288 56.603 24.871 59.186 28.014 59.186C31.157 59.186 33.74 56.603 33.74 53.46V44.233C33.74 41.09 31.157 38.507 28.014 38.507ZM28.014 56.402C26.442 56.402 25.172 55.132 25.172 53.56V44.13C25.172 42.558 26.442 41.288 28.014 41.288C29.586 41.288 30.856 42.558 30.856 44.13V53.56C30.856 55.132 29.586 56.402 28.014 56.402Z" fill="#FEFEFE"></pre>
