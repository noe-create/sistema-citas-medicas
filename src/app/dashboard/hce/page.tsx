      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-1 h-fit">
          <CardHeader>
            ...
            <CardDescription>
              Busque por nombre o cédula para ver el historial.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <HceSearch onPatientSelect={setSelectedPatient} />
          </CardContent>
        </Card>
        ...
        <div className="lg:col-span-2">
            {selectedPatient ? (
                <Card>
                    <CardHeader>
                        <CardTitle>Historial de: {selectedPatient.nombreCompleto}</CardTitle>
                        <CardDescription>Cédula: {selectedPatient.cedula}</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <PatientHistory patientDbId={selectedPatient.id} />
                    </CardContent>
                </Card>
            ) : (
                <div className="flex h-full min-h-[400px] flex-col items-center justify-center rounded-lg border border-dashed bg-card/50 p-8 text-center">
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">
                        Use el buscador para encontrar un paciente y ver su historial clínico completo.
                    </p>
                </div>
            )}
        </div>
